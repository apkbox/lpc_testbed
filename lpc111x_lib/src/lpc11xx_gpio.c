...
{    
    ...
    pGPIO->MASKED_ACCESS[pins & GPIO_PINS_MASK] = pins & GPIO_PINS_MASK;        
}
...
{    
    ...
    pGPIO->MASKED_ACCESS[pins & GPIO_PINS_MASK] = 0;            
}
 ...
 *               -PORT2 : GPIO2
 *               -PORT3 : GPIO3
 * @param[in]   specifies the port bits to be toggled (0 - 11)
 * @return      None
 *********************************************************************/
void GPIO_ToggleBits (uint8_t port, uint32_t pins)
{
    LPC_GPIO_TypeDef *pGPIO;
    ...
    pGPIO->MASKED_ACCESS[pins & GPIO_PINS_MASK] = ~(pGPIO->MASKED_ACCESS[pins & GPIO_PINS_MASK]);
}


/********************************************************************//**
 * @brief       Performs a masked write.
 * @param[in]   specifies the port, it can be
 *               -PORT0 : GPIO0
 *               -PORT1 : GPIO1
 *               -PORT2 : GPIO2
 *               -PORT3 : GPIO3
 * @param[in]   specifies the port mask (0 - 11)
 * @param[in]   specifies the port value to be written (0 - 11)
 * @return      None
 *********************************************************************/
void GPIO_MaskedWrite(uint8_t port, uint32_t mask, uint32_t value)
{
    LPC_GPIO_TypeDef *pGPIO;
    ...
    pGPIO->MASKED_ACCESS[mask & GPIO_PINS_MASK] = value & mask & GPIO_PINS_MASK;
}
