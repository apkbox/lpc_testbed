...
#define PARAM_SCK0(n)     ((n==SCK0_PIO0_10) || (n==SCK0_PIO2_11) || (n==SCK0_PIO0_6))
 ...
 */
#define IOCON_PIO0_0      offsetof(LPC_IOCON_TypeDef, RESET_PIO0_0)
...
#define PIO2_8_FUN_PIO             0     /** Selects function PIO */
