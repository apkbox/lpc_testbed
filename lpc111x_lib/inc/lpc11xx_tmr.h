...
#ifndef __LPC11XX_TMR_H_
#define __LPC11XX_TMR_H_
...
/** @defgroup TMR_REGISTER_BIT_DEFINITION
 * @{
 */
...
#define PARAM_TIM_MODE_OPT(MODE)	((	MODE	==TIM_TIMER_MODE)|| \
									...
									(	MODE	==TIM_COUNTER_FALLING_MODE)|| \
								    (	MODE	==TIM_COUNTER_ANY_MODE))
...
/** @brief Timer/counter External Match Output */
typedef enum {
	TIM_PINS_MAT0 = 0,	/*!< External Match Output 0 */
	TIM_PINS_MAT1,      /*!< External Match Output 1 */
    TIM_PINS_MAT2,      /*!< External Match Output 2 */
    TIM_PINS_MAT3,      /*!< External Match Output 3 */
} TIM_MATCH_PINS;
#define PARAM_TIM_MAT_PINS(pin)     (( pin == TIM_PINS_MAT0 ) || \
                                     ( pin == TIM_PINS_MAT1 ) || \
                                     ( pin == TIM_PINS_MAT2 ) || \
                                     ( pin == TIM_PINS_MAT3 ) )
...
/* Public Macros -------------------------------------------------------------- */
/** @defgroup TMR_Public_Macros
 * @{
 */

/** Macro to determine if it is valid TIMER peripheral */
#define PARAM_TIMx(n)	((n==LPC_TMR16B0) || \
                         (n==LPC_TMR16B1) || \
                         (n==LPC_TMR32B0) || \
                         (n==LPC_TMR32B1))
...
uint32_t TIM_GetCaptureValue(LPC_TMR_TypeDef *TIMx);
void TIM_CapturePins(LPC_TMR_TypeDef *TIMx);
void TIM_MatchPins(LPC_TMR_TypeDef *TIMx, uint8_t matFlag);
